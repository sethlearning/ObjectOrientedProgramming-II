...
namespace Lab_8._5
{
    ...
    {
        public static event EventHandler<VectorWrongEventArgs> WrongValue;
        ...
        public static void FillInVectorCoordinates(Vector3 v)
        {
            ...
            {
                WrongValue?.Invoke(v, new VectorWrongEventArgs(str));
            }
    ...
    internal class Program
    {
        static void Main()
        {
            ...
            Vector3Utilities.WrongValue += VectorWrongEventHandlers.OnWrongValue;
            ...
            Vector3Utilities.FillInVectorCoordinates(v1);

            Console.WriteLine();
            Console.WriteLine("Vector 2");
            //Vector3.FillInVectorCoordinates(v2);
            Vector3Utilities.FillInVectorCoordinates(v2);
